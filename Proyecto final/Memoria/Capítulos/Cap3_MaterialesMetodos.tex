...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./figuras_Nico/diagramaNoObjetivo.png}
    \caption{Esquema de control del LiDAR sin objetivo}
    \label{fig:img1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./figuras_Nico/diagramaSiObjetivo.png}
    \caption{Esquema de control del LiDAR con objetivo}
    \label{fig:img1}
\end{figure}
...
Stable Baselines3 \cite{stable_baselines3} es una librería de código abierto basada en PyTorch que proporciona implementaciones estandarizadas y fiables de algoritmos de Aprendizaje por Refuerzo (como PPO, SAC o DQN). Su principal ventaja reside en ofrecer una API de alto nivel simplificada, lo que facilita el entrenamiento rápido de agentes y asegura la reproducibilidad de los experimentos científicos.
...
\subsection{GitHub}
Para la organización del trabajo hemos hecho uso de esta herramienta, ya que nos ha permitido trabajar de una forma organiizada y segura.
Nuestro Proyecto: \href{https://github.com/cmirlop/T1_Modelado_Robots.git}{Link al repositorio}
