...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{../fig_Carlos/Resultados1_PPO9.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{../fig_Carlos/Resultados2_PPO9.png}
  \caption{Longitud media y recompensa media por episodio}
  \label{fig:Res2_1}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{../fig_Carlos/Resultados1_PPO12.png}
  \caption{Longitud media y recompensa media por episodio}
  \label{fig:Res1_2}
\end{figure}
¡ 
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{../fig_Carlos/Resultados2_PPO12.png}
  \caption{Longitud media y recompensa media por episodio}
  \label{fig:Res2_2}
\end{figure}
