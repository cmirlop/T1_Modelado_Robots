...
\begin{Resumen}
El presente proyecto aborda el desafío de la navegación autónoma en robótica móvil 
mediante el uso de percepción visual. El trabajo se centra en el modelado y control 
del robot TurtleBot3 dentro de un entorno de simulación desarrollado en \textbf{Unity}. 
El objetivo fundamental es implementar estrategias de control que permitan al robot alcanzar 
objetivos definidos utilizando cámaras RGB/RGB-D, explorando tanto algoritmos de navegación 
clásicos como técnicas de Aprendizaje por Refuerzo (Reinforcement Learning), y evaluando su 
desempeño en escenarios controlados.
\end{Resumen}
