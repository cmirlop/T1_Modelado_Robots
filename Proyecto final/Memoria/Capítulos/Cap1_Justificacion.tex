...
El \textbf{objetivo principal} es diseñar, implementar y validar un sistema de control para la navegación autónoma del Jetbot 
...
\begin{enumerate}
    \item \textbf{Configuración del entorno de simulación:} Integrar el modelo cinemático y visual del Jetbot en el motor Unity, incorporando sensores virtuales de visión y laser(LiDAR) y diseñando escenarios de prueba con metas específicas.
...
\begin{itemize}
    \item \textbf{Capítulo 1: Introducción, objetivos y estructura.} Presenta el contexto del problema, justifica el uso de Unity y el Jetbot, y define las metas del trabajo.
