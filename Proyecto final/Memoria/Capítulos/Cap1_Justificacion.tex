...
de un entorno de simulación de alta fidelidad (IsaacSim/IsaacLab). El objetivo fundamental es 
...
\begin{enumerate}
    ...
    el modelo cinemático y visual del TurtleBot3 en el entorno IsaacSim/IsaacLab, integrando 
    ...
    entrenar un agente basado en RL (explorando arquitecturas con redes neuronales convolucionales 
    - CNNs) capaz de aprender la política de navegación óptima mediante la interacción prueba-error con el entorno simulado.
