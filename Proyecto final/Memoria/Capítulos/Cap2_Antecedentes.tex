...
\end{equation}
\noindent
Esta formulación es la base para el análisis de estabilidad y diseño de controladores avanzados \cite{spong2020robot}. Donde cada término tiene una interpretación física crítica para el control:
