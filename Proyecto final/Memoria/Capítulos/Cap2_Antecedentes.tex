...
Al igual que en el trabajo de \cite{Gandara2020}, este proyecto selecciona al \textbf{JetBot} como la plataforma robótica de experimentación debido a su compatibilidad con sensores LIDAR y su versatilidad para la investigación académica.
...
\begin{enumerate}
    ...
    \item \textbf{PPO (Nuestro Proyecto):} Nuestro trabajo da el siguiente paso utilizando \textbf{Proximal Policy Optimization (PPO)}. A diferencia del DQN usado por \cite{alfaro2023deteccion}, PPO es un algoritmo de gradiente de política (\textit{Policy-based}) que suele ofrecer mayor estabilidad y facilidad de ajuste en entornos con espacios de acción continuos o complejos, siendo ideal para la navegación suave que requiere el JetBot en los laberintos de Unity.
\end{enumerate}
